...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheckpointCondition) DeepCopyInto(out *CheckpointCondition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheckpointCondition.
func (in *CheckpointCondition) DeepCopy() *CheckpointCondition {
	if in == nil {
		return nil
	}
	out := new(CheckpointCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CheckpointStatus) DeepCopyInto(out *CheckpointStatus) {
	*out = *in
	...
	if in.Conditions != nil {
		...
		*out = make([]CheckpointCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
